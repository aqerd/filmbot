...
public record MovieParameters(
    ...
    public MovieParameters() {
        this(TMDB_TOKEN, "G",false, "en", 1, "1900-01-01",
                "2100-01-01", "popularity.desc", 0, 10, "",
                "US", 0, 0);
    }

    public MovieParameters withToken(String token) {
        return new MovieParameters(token, this.certificationLte, this.includeAdult, this.language, this.page, this.releaseDateGte,
    ...
    public MovieParameters withCertificationLte(String certificationLte) {
        return new MovieParameters(this.token, certificationLte, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withIncludeAdult(boolean includeAdult) {
        return new MovieParameters(this.token, this.certificationLte, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withLanguage(String language) {
        return new MovieParameters(this.token, this.certificationLte, this.includeAdult, language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withPage(int page) {
        return new MovieParameters(this.token, this.certificationLte, this.includeAdult, this.language, page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateGte(String releaseDateGte) {
        return new MovieParameters(this.token, this.certificationLte, this.includeAdult, this.language, this.page, releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateLte(String releaseDateLte) {
        return new MovieParameters(this.token, this.certificationLte, this.includeAdult, this.language, this.page, this.releaseDateGte,

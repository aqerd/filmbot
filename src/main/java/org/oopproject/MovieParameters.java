...
public record MovieParameters(
    ...
    public MovieParameters withToken(String token) {
        return new MovieParameters(token, this.includeAdult, this.language, this.page, this.releaseDateGte,
    ...
    public MovieParameters withIncludeAdult(boolean includeAdult) {
        return new MovieParameters(this.token, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withLanguage(String language) {
        return new MovieParameters(this.token, this.includeAdult, language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withPage(int page) {
        return new MovieParameters(this.token, this.includeAdult, this.language, page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateGte(String releaseDateGte) {
        return new MovieParameters(this.token, this.includeAdult, this.language, this.page, releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateLte(String releaseDateLte) {
        return new MovieParameters(this.token, this.includeAdult, this.language, this.page, this.releaseDateGte,

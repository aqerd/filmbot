...
public record MovieParameters(
    ...
    public MovieParameters withToken(String token) {
        return new MovieParameters(token, this.certificationLte, this.certificationCountry, this.includeAdult, this.language, this.page, this.releaseDateGte,
    ...
    public MovieParameters withCertificationLte(String certificationLte) {
        return new MovieParameters(this.token, certificationLte, this.certificationCountry, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withCertificationCountry(String certificationCountry) {
        return new MovieParameters(this.token, this.certificationLte, certificationCountry, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withIncludeAdult(boolean includeAdult) {
        return new MovieParameters(this.token, this.certificationLte, this.certificationCountry, includeAdult, this.language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withLanguage(String language) {
        return new MovieParameters(this.token, this.certificationLte, this.certificationCountry, this.includeAdult, language, this.page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withPage(int page) {
        return new MovieParameters(this.token, this.certificationLte, this.certificationCountry, this.includeAdult, this.language, page, this.releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateGte(String releaseDateGte) {
        return new MovieParameters(this.token, this.certificationLte, this.certificationCountry, this.includeAdult, this.language, this.page, releaseDateGte,
                this.releaseDateLte, this.sortBy, this.voteAverageGte, this.voteAverageLte, this.withGenres,
                this.withOriginCountry, this.withRuntimeGte, this.year);
    }

    public MovieParameters withReleaseDateLte(String releaseDateLte) {
        return new MovieParameters(this.token, this.certificationLte, this.certificationCountry, this.includeAdult, this.language, this.page, this.releaseDateGte,
